console.log(`.679.....662....71............................805..........862.680...................................................................687....
...
...............383...........................372..................................474...................................432.471......729....`
  ...
  .map((x, index, lines) => {
    ...
    let i = 0;
    while (true) {
      const numbers = /[\d]+/gd.exec(x.substring(i));
      if (numbers) {
        const minSearch = numbers.indices[0][0] + i - 1;
        const maxSearch = numbers.indices[0][1] + i + 1;

        if ((lines[index - 1] && lines[index - 1].substring(minSearch, maxSearch).length && ![...lines[index - 1].substring(minSearch, maxSearch)].every(z => /^[.\d]+$/.test(z))) || 
        ![...lines[index].substring(minSearch, maxSearch)].every(z => /^[.\d]+$/.test(z)) ||
        (lines[index + 1] && lines[index + 1].substring(minSearch, maxSearch).length && ![...lines[index + 1].substring(minSearch, maxSearch)].every(z => /^[.\d]+$/.test(z)))
        ) {
          validOnes += parseInt(numbers[0]);
        }

        i += numbers.indices[0][1];
        continue;
      }
...
const getNumber = (line, index) => {
  ...
  while (/[\d]+/.test(line[startIndex - 1])) {
    startIndex--;
  }

  let endIndex = index + 1;
  while (/[\d]+/.test(line[endIndex])) {
    endIndex++;
  }
...
...............383...........................372..................................474...................................432.471......729....`
  ...
  .map((x, index, lines) => {
    ...
    let i = 0;
    while (true) {
      const numbers = /[*]+/gd.exec(x.substring(i));
      if (numbers) {
        const minSearch = numbers.indices[0][0] + i - 1;
        const maxSearch = numbers.indices[0][1] + i + 1;
        const gearRatios = [];

        if (lines[index - 1] && lines[index - 1].substring(minSearch, maxSearch).length && [...lines[index - 1].substring(minSearch, maxSearch)].some(z => /^[\d]+$/.test(z))) {
          gearRatios.push(getNumber(lines[index - 1], [...lines[index - 1].substring(minSearch, maxSearch)].findIndex(y => /^[\d]+$/.test(y)) + minSearch));

          if (/\d\.\d/.test(lines[index - 1].substring(minSearch, maxSearch))) {
            gearRatios.push(getNumber(lines[index - 1], [...lines[index - 1].substring(minSearch, maxSearch)].findIndex(y => /^[\d]+$/.test(y)) + minSearch + 2));
          }
        }

        if ([...lines[index].substring(minSearch, maxSearch)].some(z => /^[\d]+$/.test(z))) {
          gearRatios.push(getNumber(lines[index], [...lines[index].substring(minSearch, maxSearch)].findIndex(y => /^[\d]+$/.test(y)) + minSearch));

          if (/\d\*\d/.test(lines[index].substring(minSearch, maxSearch))) {
            gearRatios.push(getNumber(lines[index], [...lines[index].substring(minSearch, maxSearch)].findIndex(y => /^[\d]+$/.test(y)) + minSearch + 2));
          }
        }
        ...
        if (gearRatios.length > 1) {
          gearRatioSums += parseInt(gearRatios[0]) * parseInt(gearRatios[1]);
        }
